...
export const ProjectInfo: React.FC = () => {
  return (
    <div className="w-screen min-h-screen bg-gradient-to-br from-slate-50 via-slate-100 to-slate-200 p-0 m-0">
      <div className="w-full h-full flex flex-col items-center justify-center">
        {/* Project Header */}
        <div className="w-full max-w-6xl bg-white/80 backdrop-blur-sm border border-slate-200 rounded-2xl p-8 mb-8 shadow-2xl mt-8">
        ...
        {/* Team Members */}
        <div className="w-full max-w-6xl bg-white/80 backdrop-blur-sm border border-slate-200 rounded-2xl p-8 shadow-2xl mb-8">
