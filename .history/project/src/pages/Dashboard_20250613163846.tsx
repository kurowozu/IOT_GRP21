          ...
          <div className="bg-slate-800/70 border border-slate-700/50 rounded-xl p-5 shadow-lg">
            ...
            <div className="flex flex-col gap-3 text-sm text-slate-200">
              <div className="flex justify-between">
                ...
                <span className="font-semibold text-teal-300">{systemInfo.version}</span>
              </div>
              <div className="flex justify-between">
                <span>Thời gian hoạt động</span>
                <span className="font-semibold text-cyan-300">{systemInfo.uptime}</span>
              </div>
              <div className="flex justify-between">
                <span>Kết nối MySQL</span>
                <span className={`font-semibold ${systemInfo.mysql === 'Đã kết nối' ? 'text-emerald-400' : 'text-rose-400'}`}>
                  {systemInfo.mysql}
                </span>
              </div>
              <div className="flex justify-between">
                <span>Kết nối ESP32</span>
                <span className={`font-semibold ${systemInfo.esp32 === 'Đã kết nối' ? 'text-emerald-400' : 'text-rose-400'}`}>
                  {systemInfo.esp32}
                </span>
              </div>
              <div className="flex justify-between">
                <span>Địa chỉ WebSocket</span>
                <span className="font-semibold text-amber-300">
                  ws://{systemInfo.wsIp}:{systemInfo.wsPort}
                </span>
              </div>
              <div className="flex justify-between">
