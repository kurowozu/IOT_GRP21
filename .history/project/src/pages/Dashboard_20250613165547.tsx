  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-6">
      <div className="container mx-auto max-w-7xl flex flex-col gap-8">
        ...
        {/* 1. Header: Tên hệ thống và trạng thái */}
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-2">
          <div>
            <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-emerald-400 via-teal-400 to-cyan-400 bg-clip-text text-transparent uppercase mb-2">
              HỆ THỐNG CẢNH BÁO TRÁNH VẬT CẢN
            </h1>
            <p className="text-lg text-slate-300 font-light">Obstacle Avoidance Warning System</p>
          </div>
        ...
        {/* 2. Main content: Cảm biến & Điều khiển */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Sensor Panel */}
          <div className="bg-slate-800/70 border border-slate-700/50 rounded-2xl p-6 shadow-xl">
        ...
        {/* 3. Thông tin hệ thống, cài đặt ngưỡng, bản đồ */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Thông tin hệ thống */}
          <div className="bg-slate-800/80 border border-slate-700/50 rounded-2xl p-6 shadow-lg">
            <h2 className="text-xl font-semibold text-white mb-4">Thông tin hệ thống</h2>
            <div className="flex flex-col gap-3 text-sm text-slate-200">
              ...
              <div className="flex justify-between">
                <span className="font-medium">Trạng thái MySQL:</span>
                <span>{systemInfo.mysql}</span>
              </div>
              <div className="flex justify-between">
                <span className="font-medium">Trạng thái ESP32:</span>
                <span>{systemInfo.esp32}</span>
              </div>
              <div className="flex justify-between">
                <span className="font-medium">IP WebSocket:</span>
                <span>{systemInfo.wsIp}</span>
              </div>
              <div className="flex justify-between">
                <span className="font-medium">Cổng WebSocket:</span>
                <span>{systemInfo.wsPort}</span>
              </div>
              <div className="flex justify-between">
          ...
          {/* Cài đặt ngưỡng */}
          <div className="bg-slate-800/80 border border-slate-700/50 rounded-2xl p-6 shadow-lg flex flex-col gap-4">
            <div className="font-semibold text-white text-lg mb-2">Cài đặt ngưỡng:</div>
          ...
          {/* Google Map */}
          <div className="bg-slate-800/80 border border-slate-700/50 rounded-2xl p-4 shadow-lg flex flex-col gap-4 items-center">
            <h2 className="text-lg font-semibold text-white mb-2">Vị trí hệ thống</h2>
            <GoogleMap />
          </div>
        </div>
      </div>
